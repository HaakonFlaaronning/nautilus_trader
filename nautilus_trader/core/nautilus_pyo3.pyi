...
class MASlope:
    ...
    @property
    def start_bars_ago(self) -> int: ...
    @property
    def end_bars_ago(self) -> int: ...
    @property
...
class WaveTrendOscillator:
    ...
    def has_inputs(self) -> bool: ...
    @property
    def wt_fast(self) -> float: ...
    @property
    def wt_slow(self) -> float: ...
    def update_raw(self, high: float, low: float, close: float) -> None: ...
    def handle_quote_tick(self, quote: QuoteTick) -> None: ...
    def handle_trade_tick(self, trade: TradeTick) -> None: ...
    def handle_bar(self, bar: Bar) -> None: ...
...
class ZigZag:
    def __init__(
        ...
        use_point_deviation_type: bool | None = None,
        use_high_low: bool | None = None,
    ) -> None: ...
    @property
    def name(self) -> str: ...
    @property
    ...
    @property
    def use_point_deviation_type(self) -> bool: ...
    @property
    def use_high_low(self) -> bool: ...
    @property
    def initialized(self) -> bool: ...
    @property
    def has_inputs(self) -> bool: ...
    ...
    @property
    def last_swing_price(self) -> float: ...
    @property
    def trend_direction(self) -> int: ...
    @property
    def last_swing_idx(self) -> int: ...
    @property
    def count(self) -> int: ...
    def update_raw(self, high: float, low: float, close: float) -> None: ...
    def handle_bar(self, bar: Bar) -> None: ...
    ...
    def get_high_bars(self) -> list[int]: ...
    def get_low_bars(self) -> list[int]: ...
    def high_bar(self, bars_ago: int, instance: int, lookback_period: int) -> int: ...
    def low_bar(self, bars_ago: int, instance: int, lookback_period: int) -> int: ...
...
class HyperliquidHttpClient:
    ...
    def update_builder_maker_fee(self, user_add_rate: float) -> tuple[int, int]: ...
