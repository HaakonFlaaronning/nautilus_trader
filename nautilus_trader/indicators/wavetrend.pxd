...
cdef class WaveTrendOscillator(Indicator):
    cdef MovingAverage _esa
    cdef MovingAverage _d_ema
    cdef MovingAverage _tci_ema
    cdef MovingAverage _wt_slow

    cdef readonly int channel_length
    ...
    """The current WaveTrend slow value.\n\n:returns: `double`"""
